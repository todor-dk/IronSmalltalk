...
namespace IronSmalltalk.ExpressionCompiler.Primitives.Exceptions
{
    ...
    public class PrimitiveInternalException : InternalCodeGenerationException
    {
        ...
        public PrimitiveInternalException(string message)
            : base(message)
        {
        }
        public PrimitiveInternalException(string message, Exception inner)
            : base(message, inner)
        {
        }
#if !SILVERLIGHT
        protected PrimitiveInternalException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
#endif
