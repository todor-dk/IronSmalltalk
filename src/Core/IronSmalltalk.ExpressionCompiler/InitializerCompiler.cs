    ...
    public sealed class InitializerCompiler : ExpressionCompiler
    {
            ...
            : base(runtime, compilerOptions)
        {
            ...
            if (reservedScope == null)
                throw new ArgumentNullException(nameof(reservedScope));
        ...
        public Expression<Func<object, ExecutionContext, object>> CompileInitializer(InitializerNode parseTree, string initializerName)
        {
            ...
            RootCompilationContext context = new RootCompilationContext(this, this.GlobalScope, this.ReservedScope, self, executionContext, Array.Empty<ParameterExpression>(), null, initializerName);
