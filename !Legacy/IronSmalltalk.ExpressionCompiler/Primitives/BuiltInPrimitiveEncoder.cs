    ...
    public sealed class BuiltInPrimitiveEncoder : PrimitiveEncoder
    {
            ...
            : base(visitor, parameters)
        {
            if (String.IsNullOrWhiteSpace(primitiveName))
                throw new ArgumentNullException(nameof(primitiveName));
        ...
        private Expression GenerateExpression()
        {
            ...
            if (!Enum.TryParse(this.PrimitiveName, out primitive))
                throw new PrimitiveSemanticException(String.Format(CultureInfo.InvariantCulture, CodeGenerationErrors.WrongPrimitive, this.PrimitiveName));
            ...
            switch (primitive)
            {
                ...
                case BuiltInPrimitiveEnum.Negate:
                    ...
                    break;
                default:
                    throw new NotImplementedException($"Primitive {primitive} is not implemented. This is a bug!");
            }
            return exp;
        }
...
#pragma warning restore SA1137 // Elements should have the same indentation
        ...
        private Expression Shift()
        {
            ...
            if (NativeTypeClassMap.GetType(this.Parameters[1]) != typeof(int))
                throw new PrimitiveInvalidTypeException(String.Format(CultureInfo.InvariantCulture, CodeGenerationErrors.WrongShiftTypeName, this.Parameters[1]));
            ...
            if (type == typeof(System.Numerics.BigInteger))
                ...
                throw new PrimitiveInvalidTypeException(String.Format(CultureInfo.InvariantCulture, CodeGenerationErrors.WrongShiftTypeName, this.Parameters[0]));
