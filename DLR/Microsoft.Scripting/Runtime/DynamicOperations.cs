...
namespace Microsoft.Scripting.Runtime {
    ...
    public sealed partial class DynamicOperations {
        ...
        public object ConvertTo(object obj, Type type) {
            if (type.GetTypeInfoInternal().IsInterface || type.GetTypeInfoInternal().IsClass) {
                CallSite<Func<CallSite, object, object>> site;
            ...
            foreach (MethodInfo mi in typeof(DynamicOperations).GetTypeInfoInternal().GetDeclaredMethods("ConvertTo")) {
