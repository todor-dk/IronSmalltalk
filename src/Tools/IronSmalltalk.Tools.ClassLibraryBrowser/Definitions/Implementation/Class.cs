...
namespace IronSmalltalk.Tools.ClassLibraryBrowser.Definitions.Implementation
{
    public class Class : GlobalItem, IInitializableObject
    {
            ...
            : base(parent)
        {
            ...
            this.InstanceVariables = new ObservableSortedSet<string>();
            this.ClassVariables = new ObservableSortedSet<string>();
            this.ClassInstanceVariables = new ObservableSortedSet<string>();
            this.SharedPools = new ObservableSortedSet<string>();
            this.InstanceMethods = new ObservableHashSet<Method>();
            this.ClassMethods = new ObservableHashSet<Method>();
            this.Initializer = new Initializer<Class>(this);
            this.ImplementedInstanceProtocols = new ObservableSortedSet<string>();
            this.ImplementedClassProtocols = new ObservableSortedSet<string>();
        }
