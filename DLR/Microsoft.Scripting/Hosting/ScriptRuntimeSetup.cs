    ...
    public sealed class ScriptRuntimeSetup {
        ...
        public Type HostType {
            ...
            set {
                ...
                ContractUtils.Requires(typeof(ScriptHost).GetTypeInfoInternal().IsAssignableFrom(value.GetTypeInfoInternal()), "value", "Must be ScriptHost or a derived type of ScriptHost");
                CheckFrozen();
                _hostType = value;
            }
        }
