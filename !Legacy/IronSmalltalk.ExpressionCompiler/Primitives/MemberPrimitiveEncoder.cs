            ...
            foreach (string typeName in parameters)
            {
                ...
                if (first && (typeName == "this"))
                {
                    if (this.DefiningType == null)
                        throw new ArgumentException("this.DefiningType is null");
                ...
                else
                {
                    ...
                    if (type == null)
                        throw new PrimitiveInvalidTypeException(String.Format(CultureInfo.InvariantCulture, CodeGenerationErrors.WrongTypeName, typeName));
