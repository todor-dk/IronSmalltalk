...
namespace System.Reflection {
    public static class RuntimeReflectionExtensionsInternal {
        public static MethodInfo GetRuntimeBaseDefinitionInternal(this MethodInfo method) {
...
namespace Microsoft.Scripting.Utils {
    ...
    public static class ReflectionUtils {
        ...
        private static bool IncludeMethod(MethodInfo member, Type reflectedType, HashSet<MethodInfo> baseDefinitions, bool flattenHierarchy) {
            if (member.IsVirtual) {
                if (baseDefinitions.Add(RuntimeReflectionExtensionsInternal.GetRuntimeBaseDefinitionInternal(member))) {
                    return true;
                }
        ...
        private static bool IncludeProperty(PropertyInfo member, Type reflectedType, HashSet<MethodInfo> baseDefinitions, bool flattenHierarchy) {
            ...
            if (virtualAccessor != null) {
                if (baseDefinitions.Add(RuntimeReflectionExtensionsInternal.GetRuntimeBaseDefinitionInternal(virtualAccessor))) {
                    return true;
                }
            } else if (member.DeclaringType == reflectedType) {
                return true;
