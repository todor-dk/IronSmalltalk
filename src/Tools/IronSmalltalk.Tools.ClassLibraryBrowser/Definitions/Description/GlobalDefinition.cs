...
namespace IronSmalltalk.Tools.ClassLibraryBrowser.Definitions.Description
{
    ...
    public class GlobalClass : GlobalDefinition
    {
        ...
        public GlobalClass(Global parent)
            : base(parent)
        {
            this.ClassInstanceVariables = new ObservableCollection<string>();
            this.ClassVariables = new ObservableCollection<string>();
            this.ImportedPools = new ObservableCollection<string>();
            this.InstanceVariables = new ObservableCollection<string>();
        }
    ...
    public class GlobalPool : GlobalDefinition
    {
        ...
        public GlobalPool(Global parent)
            : base(parent)
        {
            this.Items = new ObservableCollection<PoolValue>();
        }
